...
// кафизма в день
let kathismaElements =
document. querySelectorAll('.kathisma');
...
currentDayKathisma) % kathismaElements.length) {
...
currentDayKathisma = (currentDayKathisma + 1) %
kathismaElements.length;
